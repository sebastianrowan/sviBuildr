#' Download EJI data files directly from the CDC ATSDR Website.
#'
...
#' @export
get_svi_from_cdc <- function(state, geography, year, state = NULL, geometry = FALSE) {
  ...
  base_url <- "eji.cdc.gov/Documents/Data"
