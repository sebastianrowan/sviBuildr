...
The figures below show histograms of tract level comparisons of the SVI scores calculated by `svibuildr` and the values in the datasets downloaded from the CDC. 
